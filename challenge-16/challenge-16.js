(() => {
    ...
    */
    ...
    console.log(
        names.reduce((prev, current, index, array) => {
            var max = array.length - 1;
            return prev += index < max ? ', ' + current : ' e ' + current;
        }), 'são meus amigos.'
    );
    ...
    console.log(
        myName.split('')
            .reduce((prev, current, index) => {
                return prev += index % 2 == 0 ? current.toUpperCase() : current.toLowerCase();
            }
        )
    );
})();
