(function(){
  ...
  */
  var People = function(name, lastName){
    this.name = name;
    this.lastName = lastName;
  }
  var people1 = new People('Ricardo', 'Gosch');
  var people2 = new People('Fernando', 'Daciuk');
  ...
  */
  ...
  console.log(sum(2, 5, 10, 20));
  console.log(sum(25, 1, 4, 70, 1));
  console.log(sum(5, 2, 0, 7, 4));
